...
public class ComponentFactory {
    ...
    @Autowired(required = false)
    private ItemLabelGenerator<Todo> todoItemLabelGenerator;
    ...
    public Button createButton(String text) {
        Button button = new Button(text).setBackgroundColor("white")
                .setBorder("solid 1px")
    ...
    public Button createBackButton(Supplier<Optional<UI>> uiSupplier, String urlBack, SessionData sessionData) {
        Button buttonBack = createButton(
    ...
    public Button createLogoutButton(Supplier<Optional<UI>> uiSupplier, Logger logger, SessionData sessionData) {
        Button buttonLogout = createButton(
                resourceManager.getLocalizedString("commons.button.logout.text", sessionData.getLocalization()));
    ...
    public <T> ComboBox<T> createComboBox(String resourceId, T fieldContent, T[] valuesToSelect,
        ...
        ComboBox<T> comboBox = new ComboBox<>(
                resourceManager.getLocalizedString(resourceId, sessionData.getLocalization()));
